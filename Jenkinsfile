        ...
        stage('Push Image 2 Hub') {
         ...
         stage ('deploy') {
             steps {
                 ...
                 sh 'ssh -t -t -o StrictHostKeyChecking=no -i /var/lib/jenkins/.ssh/id_rsa.pub ec2-user@172.31.94.218 && sudo -i && helm upgrade first ./firstrepo && kubectl get all -o wide'
